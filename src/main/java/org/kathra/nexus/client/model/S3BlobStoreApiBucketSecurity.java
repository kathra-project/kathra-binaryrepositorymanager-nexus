...
public class S3BlobStoreApiBucketSecurity {
   ...
   * @return accessKeyId
  **/
  @ApiModelProperty(value = "An IAM access key ID for granting access to the S3 bucket")
  ...
  **/
  @ApiModelProperty(value = "The secret access key associated with the specified IAM access key ID")
   ...
   * @return role
  **/
  @ApiModelProperty(value = "An IAM role to assume in order to access the S3 bucket")
   ...
   * @return sessionToken
  **/
  @ApiModelProperty(value = "An AWS STS session token associated with temporary security credentials which grant access to the S3 bucket")
