...
public class UpdateLdapServerXo {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "LDAP server name")
   ...
   * @return protocol
  **/
  @ApiModelProperty(required = true, value = "LDAP server connection Protocol to use")
  ...
  public UpdateLdapServerXo useTrustStore(Boolean useTrustStore) {
   ...
   /**
   * Whether to use certificates stored in NXRM&#39;s truststore
   * @return useTrustStore
  **/
  @ApiModelProperty(value = "Whether to use certificates stored in NXRM's truststore")
   ...
   * @return host
  **/
  @ApiModelProperty(required = true, value = "LDAP server connection hostname")
   ...
   * @return port
  **/
  @ApiModelProperty(example = "636", required = true, value = "LDAP server connection port to use")
   ...
   * @return searchBase
  **/
  @ApiModelProperty(example = "dc=example,dc=com", required = true, value = "LDAP location to be added to the connection URL")
   ...
   * @return authScheme
  **/
  @ApiModelProperty(required = true, value = "Authentication scheme used for connecting to LDAP server")
   ...
   * @return authRealm
  **/
  @ApiModelProperty(example = "example.com", value = "The SASL realm to bind to. Required if authScheme is CRAM_MD5 or DIGEST_MD5")
  ...
  **/
  @ApiModelProperty(example = "1", required = true, value = "How long to wait before timeout")
  ...
  **/
  @ApiModelProperty(required = true, value = "How long to wait before retrying")
  ...
  **/
  @ApiModelProperty(required = true, value = "How many retry attempts")
   ...
   * @return userBaseDn
  **/
  @ApiModelProperty(example = "ou=people", value = "The relative DN where user objects are found (e.g. ou=people). This value will have the Search base DN value appended to form the full User search base DN.")
  ...
  **/
  @ApiModelProperty(example = "inetOrgPerson", value = "LDAP class for user objects")
  ...
  **/
  @ApiModelProperty(example = "(|(mail=*@example.com)(uid=dom*))", value = "LDAP search filter to limit user search")
  ...
  **/
  @ApiModelProperty(example = "uid", value = "This is used to find a user given its user ID")
  ...
  **/
  @ApiModelProperty(example = "cn", value = "This is used to find a real name given the user ID")
  ...
  **/
  @ApiModelProperty(example = "mail", value = "This is used to find an email address given the user ID")
  ...
  **/
  ...
  public UpdateLdapServerXo ldapGroupsAsRoles(Boolean ldapGroupsAsRoles) {
   ...
   /**
   * Denotes whether LDAP assigned roles are used as NXRM roles
   * @return ldapGroupsAsRoles
  **/
  @ApiModelProperty(value = "Denotes whether LDAP assigned roles are used as NXRM roles")
   ...
   * @return groupType
  **/
  @ApiModelProperty(required = true, value = "Defines a type of groups used: static (a group contains a list of users) or dynamic (a user contains a list of groups). Required if ldapGroupsAsRoles is true.")
   ...
   * @return groupBaseDn
  **/
  @ApiModelProperty(example = "ou=Group", value = "The relative DN where group objects are found (e.g. ou=Group). This value will have the Search base DN value appended to form the full Group search base DN.")
  ...
  **/
  @ApiModelProperty(example = "posixGroup", value = "LDAP class for group objects. Required if groupType is static")
  ...
  **/
  @ApiModelProperty(example = "cn", value = "This field specifies the attribute of the Object class that defines the Group ID. Required if groupType is static")
  ...
  **/
  @ApiModelProperty(example = "memberUid", value = "LDAP attribute containing the usernames for the group. Required if groupType is static")
  ...
  **/
  @ApiModelProperty(example = "uid=${username},ou=people,dc=example,dc=com", value = "The format of user ID stored in the group member attribute. Required if groupType is static")
  ...
  **/
  @ApiModelProperty(example = "memberOf", value = "Set this to the attribute used to store the attribute which holds groups DN in the user object. Required if groupType is dynamic")
   ...
   * @return authPassword
  **/
  @ApiModelProperty(required = true, value = "The password to bind with. Required if authScheme other than none.")
   ...
   * @return id
  **/
  @ApiModelProperty(value = "LDAP server ID")
  public String getId() {
    return id;
  }
