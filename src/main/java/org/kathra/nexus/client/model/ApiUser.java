...
public class ApiUser {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The user's status, e.g. active or disabled.")
   ...
   * @return readOnly
  **/
  @ApiModelProperty(value = "Indicates whether the user's properties could be modified by Nexus. When false only roles are considered during update.")
  ...
  **/
  @ApiModelProperty(value = "The roles which the user has been assigned in an external source, e.g. LDAP group. These cannot be changed within Nexus.")
