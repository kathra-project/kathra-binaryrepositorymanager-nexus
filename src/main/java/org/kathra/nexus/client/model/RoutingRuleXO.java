...
public class RoutingRuleXO {
  ...
  **/
   ...
   * @return mode
  **/
  @ApiModelProperty(value = "Determines what should be done with requests when their path matches any of the matchers")
   ...
   * @return matchers
  **/
  @ApiModelProperty(value = "Regular expressions used to identify request paths that are allowed or blocked (depending on mode)")
